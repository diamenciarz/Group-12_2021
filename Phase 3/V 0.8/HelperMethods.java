...
public class HelperMethods {
    ...
    public static Block getBestBlock(int[] emptyVolumeDimensions, Cargo cargo) {
        ...
        //Updates the block list to throw out all blocks that we don't have enough parcels for permanently, 
    ...
    private static ArrayList<Block> getRotationsThatFit(Block block, int[] emptyVolumeDimensions) {
        ...
        if (fitsRotated3) {
            returnList.add(block.createRotation(1, 3, 0));
        }
        ...
        if (fitsRotated6) {
            returnList.add(block.createRotation(1, 0, 3));
        }
        return returnList;
    }
