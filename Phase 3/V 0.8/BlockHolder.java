...
public class BlockHolder {
    ...
    private static ArrayList<Block> createMultiplications(Block block, int[] cargoDimensions) {
        ...
        ArrayList<Block> verticalBlocks = createYRepetitions(horizontalBlocks.get(horizontalBlocks.size() - 1),
                yRepetitions);
        ...
        // weirdBlocks.get(weirdBlocks.size() - 1).print();
        return newBlocks;
    }
