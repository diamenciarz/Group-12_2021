...
public class Pentis {
    ...
    private static boolean wasValidKeyPressed = false;
    ...
    private static void doStep() {
        ...
        if (areTwoFiguresOverlapping(currentMapMatrix, shapePlacedOnGrid)) {
            ...
            int[][] displayMatrix = placeShapeOnMap(currentMapMatrix, currentShape, currentShapeXPosition,
                    currentShapeYPosition);
